...
class Distributed_Alignment_Search:
    ...
    def train_test(self,batch_size,epochs=1,mode=1,early_stopping_threshold=3,verbose=False): #1=train,2=test,3=eval
        ...
        for epoch in range(epochs):
            ...
            if mode==1:
                eval_acc=self.train_test(batch_size,epochs=1,mode=3,verbose=verbose)
                ...
                print(f"Epoch {epoch+1}, Loss: {total_loss}",
                      ...
                      "learning rate:",self.Transformation_Class.scheduler.get_last_lr(), flush=True)
                ...
                if steps_without_improvement>=early_stopping_threshold or epoch==epochs-1:
                    ...
                    optimizer = optim.Adam(Best_Phi.parameters(), lr=self.Transformation_Class.scheduler.get_last_lr())
